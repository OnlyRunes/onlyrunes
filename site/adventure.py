...
# A big coiled dragon (line-ASCII so it renders in xterm). Same art for calm
# and fire (recoloured by the builders); a separate death frame with x'd eyes.
ELVARG_ART = r'''
                                       ,;
                                    _,'/
                          ___     ,'  /
          ...
          ``--..__  ~~~~   `./   /    ,-'  `._,'
                  ``--..__   /   /  ,-'
                         ...
                         (   ((   /  \    /  \
                          `.  \V      \/      \
'''
ELVARG_CALM = ELVARG_ART
ELVARG_FIRE = ELVARG_ART
ELVARG_DIE = r'''
                                       ,;
                                    _,'/
                          ___     ,'  /
